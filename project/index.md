...
This project provides an automated classification of breast cancer subtypes using KMeans- a type of Machine Learning algorithms. The scope of the project is to identify the molecular subtypes of breast cancer using the protein  unique identifiers of the breast cancer genes and to investigate its efficacy with the established PAM50 assay.
