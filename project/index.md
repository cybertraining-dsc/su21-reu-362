...
tags: ["project", "reu"]
description: "This project provides a means to classify molecular breast cancer subtypes based on gene expression using the approach of machine earning algorithm." 
...
**Figure 2:** Pair plots of Diagnostic Features
