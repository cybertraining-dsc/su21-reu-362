...
The project investigated the number of clusters that could be generated for the protein dataset which would provide the optimal classification of the protein expression values for the breast cancer samples. The proteins that were used in the KMeans analysis were the proteins that belonged to the genes in tha PAM50 data. This result of the project could provide insights to medical scientists and reseacrhers to identify any  interelatedness between the original classification of molecular breast cancer subtypes using the PAM50 test.
...
The results of the KMeans analysis showed that three clusters provided an optimal result for the classification using a proteomic dataset. A cluster of 3 provided a balanced silhouette and homogeneity score. This predict that some interrelatedness could exist between the original PAM50 subtype classfication, since the classification based on a  protein dataset identified a cluster of 3 as one with gthe optimal result.
